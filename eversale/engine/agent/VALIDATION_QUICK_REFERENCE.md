...
- Full guide: `engine/agent/ACTION_VALIDATION_GUIDE.md`
- Test suite: `engine/agent/test_action_validation.py`
- Examples: `engine/agent/example_action_validation.py`
- Summary: `engine/agent/VALIDATION_ENHANCEMENT_SUMMARY.md`

## Code Location

**File:** `engine/agent/action_engine.py`
