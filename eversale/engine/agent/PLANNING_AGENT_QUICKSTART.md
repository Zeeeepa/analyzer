...
1. **Read Full Documentation:** `agent/PLANNING_AGENT_README.md`
2. **Check Integration Guide:** `agent/PLANNING_AGENT_INTEGRATION.md`
...
- Documentation: `agent/PLANNING_AGENT_*.md`
- Examples: `examples/planning_agent_demo.py`
- Source: `agent/planning_agent.py`
