...
Add to `eversale-cli/engine/agent/brain_enhanced_v2.py`:
...
Add to `eversale-cli/engine/agent/playwright_direct.py`:
...
Add to `eversale-cli/engine/agent/mcp_client.py`:
...
Add to `eversale-cli/engine/agent/workflow_handlers.py`:
...
Add to `eversale-cli/engine/agent/capabilities.py`:
...
```python
# In eversale-cli/engine/agent/__init__.py
from .complex_form_handler import (
    ComplexFormHandler,
    SiteSpecificHandlers,
    FormField,
