...
and place it at:
/__modal/.debug_shell/nix/store/wab5qmylhnhpwg8cjqr1zglzxnps3baw-d3-flame-graph-templates-4.1.3/share/d3-flame-graph/d3-flamegraph-base.html""",
                                  file=sys.stderr)
                            quit()
                        s = None
                        while s != "y" and s != "n":
...
if __name__ == "__main__":
    ...
    parser.add_argument("--template",
                        default="/__modal/.debug_shell/nix/store/wab5qmylhnhpwg8cjqr1zglzxnps3baw-d3-flame-graph-templates-4.1.3/share/d3-flame-graph/d3-flamegraph-base.html",
